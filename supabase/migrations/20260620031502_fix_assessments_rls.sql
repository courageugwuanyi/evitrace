...
DROP POLICY IF EXISTS "Allow authenticated users to insert assessments" ON public.assessments;
DROP POLICY IF EXISTS "Allow authenticated users to view own assessments" ON public.assessments;
