...
BEGIN
    ...
    -- 2. Check email domains for strict corporate alignment
    ...
    -- 3. Prevent duplicate active connections for the same manager
    ...
    -- 4. Automated override: move incumbent active direct manager to handover
    IF matched_invite.relation_type = 'manager' THEN
        ...
        VALUES (
            ...
            'New manager link redemption pushed incumbent manager to handover track.'
        );
    END IF;
