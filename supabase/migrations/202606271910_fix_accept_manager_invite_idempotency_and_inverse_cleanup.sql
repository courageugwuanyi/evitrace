...
BEGIN
    ...
    -- Preserve idempotency before domain checks so existing team links do not fail.
    SELECT id
    ...
    -- Self-heal stale inverse manager rows that can appear in local testing loops.
